...
public class PrivateController {
    ...
    // 보통은 put으로 처리를 하는게 우리나라 개발자들의 특징


    @PutMapping("/change-password")
    public ResponseEntity<?> patchChangePasswordHandle(
            @RequestAttribute("subject") String subject,
            @RequestBody @Valid ChangePassword changePassword, BindingResult result) {
        ...
        // 여기까지가 통과됐으면 찾은 객체에다가 password를 세팅시켜 (사용자가 보내준 newPassword 를 bcrypt로 암호화해서)
